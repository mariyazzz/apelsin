                  ...
                  <div class="container container-bigger swiper-main-section">
                    <div class="row row-fix justify-content-sm-center justify-content-md-start">
                      <div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5">
                        ...
                        <p class="text-spacing-sm">Заблуждения о еде, с которыми многие из нас никак не могут расстаться</p><a class="button button-default-outline button-nina button-sm" href="#">Читать далее</a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="container container-bigger swiper-main-section">
                    <div class="row row-fix justify-content-sm-center justify-content-md-start">
                      <div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5">
                        ...
                        <p class="text-spacing-sm">Еда больше чем на 50% определяет наше долгосрочное здоровье, заболеваемость самыми страшными болезнями века и очень сильно влияет на бодрость и эффективность каждый день.</p><a class="button button-default-outline button-nina button-sm" href="#">Читать далее</a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="container container-bigger swiper-main-section">
                    <div class="row row-fix justify-content-sm-center justify-content-md-start">
                      <div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5">
                        ...
                        <p class="text-spacing-sm">Полезная пища может быть вкусно приготовленной! Расскажем, как этого добиться.</p><a class="button button-default-outline button-nina button-sm" href="#">Читать далее</a>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php
    ...
    <?= $form->field($form_model,'login')->label('Ваш логин');?>
    <?= $form->field($form_model,'password')->label('Пароль');?>
          ...
          <div class="row row-50 justify-content-sm-center text-left">
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text text-spacing-sm">С помощью калькулятора вы сможете с легкостью рассчитать верное количество калорий, которое нужно употреблять ежедневно. Через несколько недель вы станете намного ближе к желаемому результату на весах.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <div class="box-minimal-text text-spacing-sm">Как же здорово - питаться правильно! 
                    Благодаря полезной и вкусной пищи можно поднять себе настроение на весь день. Также из-за легких рецептов приготовления не нужно тратить много времени, чтобы ппросто покушать.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text text-spacing-sm">Очень важно следить за своим здоровьем, наш калькулятор поможет вам в этом. Правильное количество углеводов, жиров и белков позволит забыть о растройствах пищеварения. Также пропадет изжога, усталось и сонливость. </div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text text-spacing-sm">Хороший настрой на весь день - это главный фактор успеха во всем! Вы каждый день будете просыпаться с улыбкой на лице, радовать своих родных вашем настроем и просто наслаждаться жизнью. Осталось лишь попробовать!.</div>
              </article>
            </div>
          </div>
        </div>
              ...
              <div class="owl-carousel owl-carousel-team owl-carousel-inset" data-items="1" data-md-items="2" data-xl-items="3" data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots="true" data-autoplay="true">
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/run.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-footer">
                      <time datetime="2019">Фев 27, 2022</time><a class="post-comment" href="#"></a>
                    </div>
                  </div>
                </article>
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/berries.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-footer">
                      <time datetime="2019">Яны 27, 2019</time><a class="post-comment" href="#"></a>
                    </div>
                  </div>
                </article>
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="images/gym.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    ...
                    <div class="post-blog-caption-footer">
                      <time datetime="2019">Июн 29, 2019</time><a class="post-comment" href="#"></a>
                    </div>
                  </div>
                </article>
              </div>
        ...
        <div class="container container-bigger">
          ...
          <div class="owl-carousel owl-layout-1" data-items="1" data-dots="true" data-nav="true" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-autoplay="true">
            <article class="quote-boxed">
              ...
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
                  <p>Благодаря калькулятору проекта Апельсин я уже в юном возрасте смоглас наладить свое питание и подтянуть фигуру. Очень понятный интерфейс и полезный функционал. </p>
                </div>
            ...
            <article class="quote-boxed">
              ...
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
                  <p>Я уже полгода питаюсь рецептами на этом сайте. Сначала получаю ежедневную норму калорий, потом сразу появляются интересные рецепты, которые можно готовить каждый день.</p>
                </div>
                <div class="quote-boxed-meta">
